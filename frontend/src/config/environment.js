...
export const CONFIG = {
  ...
  PRODUCTION: {
    API_URL: import.meta.env.VITE_API_URL || "https://alumni-connect-h1qr.onrender.com/api",
    BASE_URL: import.meta.env.VITE_BASE_URL || "https://alumni-connect-h1qr.onrender.com",
    WS_URL: import.meta.env.VITE_BASE_URL || "https://alumni-connect-h1qr.onrender.com",
  },
};
